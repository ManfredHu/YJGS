...
/**
 * Servlet implementation class TypeChangeForList
 */
public class TypeChangeForList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TypeChangeForList() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//步骤2：跳转到相应类别的产品列表页面
		response.sendRedirect("../ProductManage/ProductList.jsp?typeID=" + typeID);
		return;
	}
