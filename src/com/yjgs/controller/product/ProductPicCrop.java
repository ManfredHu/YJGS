...
/**
 * Servlet implementation class ProductPicCrop
 */
public class ProductPicCrop extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductPicCrop() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(pmBll.addNewProductPic(request)) {
			...
			//刷新页面
			response.sendRedirect("../ProductManage/ProductAdd2.jsp?productID=" + productID);
