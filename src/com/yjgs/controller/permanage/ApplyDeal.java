...
/**
 * Servlet implementation class ApplyDeal
 */
public class ApplyDeal extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(pBll.dealApply(apply)) {
			...
			request.setAttribute("text", "处理出错，请重试");
	...
	private PermissionApply packApply(HttpServletRequest fRequest) {
		...
		try {
			...
			apply.setRead(true);
			apply.setPass(fRequest.getParameter("Type").equals("true"));
