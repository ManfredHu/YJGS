...
/**
 * Servlet implementation class IntroPicUpload
 */
public class IntroPicUpload extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IntroPicUpload() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (imgPath != null) {
			...
			response.sendRedirect("../FirstPageManage/PicCrop3.jsp?imgPath="
