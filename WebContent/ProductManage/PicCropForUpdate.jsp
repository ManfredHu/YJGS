...
<div id="main">
	...
	<div class="secondDiv">
		...
		<form action="ProPicCrop_fd" method="post">
			...
			<input type="hidden" name="tarWidth" id="tarWidth"
				value="<%=tarWidth%>"> <input type="hidden" name="tarHeight"
				id="tarHeight" value="<%=tarHeight%>"> <input type="hidden"
